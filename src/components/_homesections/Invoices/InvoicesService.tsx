...
const invoices: Invoice[] = [
  ...
  { id: '9', no: '001401', subject: 'Design Works', client: 'Carlson Limited', vatNo: '87956621', created: '15 Dec 2017', status: 'Paid', price: '$887', countryCode: '🇺🇸' },
  { id: '12', no: '001402', subject: 'UX Wireframes', client: 'Adobe', vatNo: '87956421', created: '12 Apr 2017', status: 'Pending', price: '$1200', countryCode: '🇬🇧' },
  { id: '13', no: '001403', subject: 'New Dashboard', client: 'Bluewolf', vatNo: '87952621', created: '23 Oct 2017', status: 'Pending', price: '$534', countryCode: '🇩🇪' },
  { id: '14', no: '001404', subject: 'Landing Page', client: 'Salesforce', vatNo: '87953421', created: '2 Sep 2017', status: 'Due in 2 Weeks', price: '$1500', countryCode: '🇧🇷' },
  ...
  { id: '13', no: '001403', subject: 'New Dashboard', client: 'Bluewolf', vatNo: '87952621', created: '23 Oct 2017', status: 'Pending', price: '$534', countryCode: '🇩🇪' },
  { id: '14', no: '001404', subject: 'Landing Page', client: 'Salesforce', vatNo: '87953421', created: '2 Sep 2017', status: 'Due in 2 Weeks', price: '$1500', countryCode: '🇧🇷' },
  { id: '15', no: '001405', subject: 'Marketing Templates', client: 'Printic', vatNo: '87956621', created: '29 Jan 2018', status: 'Paid Today', price: '$648', countryCode: '🇵🇱' },
  { id: '16', no: '001406', subject: 'Sales Presentation', client: 'Tabdaq', vatNo: '87956621', created: '4 Feb 2018', status: 'Due in 3 Weeks', price: '$300', countryCode: '🇧🇷' },
  { id: '17', no: '001407', subject: 'Logo & Print', client: 'Apple', vatNo: '87956621', created: '22 Mar 2018', status: 'Paid Today', price: '$2500', countryCode: '🇺🇸' },
  { id: '18', no: '001408', subject: 'Icons', client: 'Tookapic', vatNo: '87956621', created: '13 May 2018', status: 'Paid Today', price: '$940', countryCode: '🇵🇱' },
];
...
const InvoicesService = () => {
  ...
  const lastPage = Math.ceil(invoices.length / ITEMS_PER_PAGE);
  ...
  return (
    <div className="w-[73.5%] mx-auto rounded-lg shadow-sm border border-gray-200 overflow-hidden font-sans">
            ...
            {paginatedInvoices.map(invoice => {
              ...
              return (
                <tr
                  ...
                  className={`cursor-pointer transition ${isSelected ? 'bg-[#ecf4fc]' : 'hover:bg-gray-50'}`}
                >
      ...
      <div className="p-4 border-t border-gray-100 flex justify-between text-sm text-gray-500">
        <p>
          Showing {(currentPage - 1) * ITEMS_PER_PAGE + 1} to {Math.min(currentPage * ITEMS_PER_PAGE, invoices.length)} of {invoices.length} entries
        </p>
